...
export const GanttToolbar = ({ onGoToToday, onFitZoom }) => {
  ...
  return (
    <div className="w-full flex shrink-0 border-b border-slate-700/90 bg-[#1e293b] shadow-md z-20 select-none overflow-x-auto custom-scrollbar">
      {/* SECCIÓN 1: EDICIÓN & TAREAS */}
      <div className="flex-[1.4] min-w-[340px] px-3 py-1.5 flex flex-col justify-between border-r border-slate-700/80 bg-slate-900/20 hover:bg-slate-900/40 transition-colors">
        <div className="flex items-center justify-center gap-2 min-h-[32px] flex-wrap">
          ...
          <div className="flex items-center bg-slate-900/80 p-0.5 rounded-md border border-slate-700/80">
            <button
              onClick={undo}
              disabled={!canUndo}
        ...
        <span className="text-[9px] font-bold uppercase tracking-wider text-slate-400 text-center select-none pt-1 border-t border-slate-700/40 mt-1 w-full">
          Edición & Tareas
        </span>
      </div>
      ...
      <div className="flex-[0.8] min-w-[200px] px-3 py-1.5 flex flex-col justify-between bg-slate-900/20 hover:bg-slate-900/40 transition-colors">
